...
;; URL: https://github.com/yourusername/kanso-mist-theme

;;; Commentary:
;; A dark theme for Emacs based on the Kanso Mist colorscheme.
;; Ported from https://github.com/webhooked/kanso.nvim

;;; Code:

(deftheme kanso-mist
  "A dark theme inspired by Kanso Mist colorscheme.")

(let ((class '((class color) (min-colors 89)))
      ;; Kanso Mist palette - non-saturated variants
      (mist-bg0    "#22262D")  ;; Main background
      (mist-bg1    "#2a2c35")  ;; Unused in original, approximated
      (mist-bg2    "#393B44")  ;; bg_p1 and bg_p2 in mist theme
      (mist-bg3    "#5C6066")  ;; For visual selections
  ...
  (custom-theme-set-faces
   ...
   ;; Basic faces
   `(default ((,class (:foreground ,fg :background ,mist-bg0))))
   `(cursor ((,class (:background ,fg2))))
   `(fringe ((,class (:background ,mist-bg0 :foreground ,gray5))))
   `(highlight ((,class (:background ,mist-bg2))))
   `(region ((,class (:background ,mist-bg2))))
   `(secondary-selection ((,class (:background ,mist-bg2))))
   `(buffer-menu-buffer ((,class (:foreground ,fg :weight bold))))
   `(minibuffer-prompt ((,class (:foreground ,violet2))))
   `(vertical-border ((,class (:foreground ,mist-bg2))))
   `(window-divider ((,class (:foreground ,mist-bg2))))
   `(window-divider-first-pixel ((,class (:foreground ,mist-bg2))))
   `(window-divider-last-pixel ((,class (:foreground ,mist-bg2))))
   ...
   ;; Mode line
   `(mode-line ((,class (:background ,mist-bg1 :foreground ,fg))))
   `(mode-line-inactive ((,class (:background ,mist-bg0 :foreground ,gray3))))
   ...
   `(isearch-fail ((,class (:background ,red :foreground ,mist-bg0))))
   `(lazy-highlight ((,class (:background ,mist-bg3 :foreground ,fg2))))
   ...
   `(org-block ((,class (:background ,mist-bg1))))
   `(org-block-begin-line ((,class (:background ,mist-bg1 :foreground ,gray4))))
   `(org-block-end-line ((,class (:background ,mist-bg1 :foreground ,gray4))))
   ...
   `(web-mode-html-tag-face ((,class (:foreground ,violet2))))
   ...
   ;; CSS/SCSS mode
   `(css-selector ((,class (:foreground ,yellow3))))
   ...
   `(markdown-code-face ((,class (:background ,mist-bg1 :foreground ,yellow3))))
   `(markdown-inline-code-face ((,class (:background ,mist-bg1 :foreground ,yellow3))))
   `(markdown-pre-face ((,class (:foreground ,yellow3))))

   ;; Company mode
   `(company-tooltip ((,class (:background ,mist-bg1 :foreground ,fg))))
   `(company-tooltip-selection ((,class (:background ,mist-bg3 :foreground ,fg))))
   `(company-tooltip-common ((,class (:foreground ,blue3))))
   `(company-tooltip-annotation ((,class (:foreground ,gray3))))
   `(company-scrollbar-bg ((,class (:background ,mist-bg1))))
   `(company-scrollbar-fg ((,class (:background ,gray5))))
   `(company-preview ((,class (:foreground ,blue3))))
   `(company-preview-common ((,class (:foreground ,blue3 :background ,mist-bg2))))
   ...
   `(magit-diff-context-highlight ((,class (:background ,mist-bg1 :foreground ,fg))))
   `(magit-section-heading ((,class (:foreground ,violet2 :weight bold))))
   `(magit-section-highlight ((,class (:background ,mist-bg1))))
   `(magit-hash ((,class (:foreground ,gray3))))

   ;; Helm
   `(helm-header ((,class (:background ,mist-bg0 :foreground ,fg :weight bold))))
   `(helm-source-header ((,class (:background ,mist-bg2 :foreground ,fg :weight bold))))
   `(helm-selection ((,class (:background ,mist-bg3))))
   `(helm-selection-line ((,class (:background ,mist-bg3))))
   `(helm-visible-mark ((,class (:background ,mist-bg3 :foreground ,yellow3))))
   ...
   ;; Ivy
   `(ivy-current-match ((,class (:background ,mist-bg3 :foreground ,fg))))
  ...
  ;; Centaur Tabs
  `(centaur-tabs-default ((,class (:background ,mist-bg1 :foreground ,gray3))))
  `(centaur-tabs-selected ((,class (:background ,mist-bg0 :foreground ,fg :weight bold))))
  `(centaur-tabs-unselected ((,class (:background ,mist-bg2 :foreground ,gray2))))
  `(centaur-tabs-selected-modified ((,class (:background ,mist-bg0 :foreground ,orange :weight bold))))
  `(centaur-tabs-unselected-modified ((,class (:background ,mist-bg2 :foreground ,orange2))))
  ...
  `(centaur-tabs-active-tab ((,class (:background ,mist-bg0 :foreground ,fg :weight bold))))
  `(centaur-tabs-inactive-tab ((,class (:background ,mist-bg2 :foreground ,gray2))))
  `(centaur-tabs-selected-tab ((,class (:background ,green3 :foreground ,mist-bg0 :weight bold))))
  ;; Doom-specific workspace tabs
  `(+workspace-tab-selected-face ((,class (:background ,green3 :foreground ,mist-bg0 :weight bold))))
  `(+workspace-tab-face ((,class (:background ,mist-bg2 :foreground ,gray2))))
  ;; Tab Bar (built-in Emacs tabs)
  `(tab-bar ((,class (:background ,mist-bg1 :foreground ,fg))))
  `(tab-bar-tab ((,class (:background ,mist-bg0 :foreground ,fg :weight bold))))
  `(tab-bar-tab-inactive ((,class (:background ,mist-bg2 :foreground ,gray2))))
  ;; Tab Line (built-in Emacs tab line)
  `(tab-line ((,class (:background ,mist-bg1 :foreground ,fg))))
  `(tab-line-tab ((,class (:background ,mist-bg0 :foreground ,fg :weight bold))))
  ...
  (custom-theme-set-variables
   ...
   `(ansi-color-names-vector
     [,mist-bg0 ,red3 ,green3 ,yellow3 ,blue3 ,pink ,aqua ,fg])))
