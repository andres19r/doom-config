...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
    ...
    ;; LSP and Tree-sitter
    `(lsp-face-highlight-textual ((,class (:background ,lotus-yellow-1))))
    `(lsp-face-highlight-read ((,class (:background ,lotus-yellow-2))))
    `(lsp-face-highlight-write ((,class (:background ,lotus-yellow-2))))

    ;; HTML/XML specific faces
    `(nxml-element-local-name ((,class (:foreground ,lotus-blue-0 :weight bold))))
    `(nxml-tag-delimiter ((,class (:foreground ,lotus-blue-0))))
    `(nxml-attribute-local-name ((,class (:foreground ,lotus-orange-0))))
    `(nxml-attribute-value ((,class (:foreground ,lotus-green-1))))
    `(nxml-text ((,class (:foreground ,lotus-fg-0))))

    ;; Web-mode faces (if using web-mode)
    `(web-mode-html-tag-face ((,class (:foreground ,lotus-blue-0 :weight bold))))
    `(web-mode-html-tag-bracket-face ((,class (:foreground ,lotus-blue-0))))
    `(web-mode-html-attr-name-face ((,class (:foreground ,lotus-orange-0))))
    `(web-mode-html-attr-value-face ((,class (:foreground ,lotus-green-1))))
    `(web-mode-html-entity-face ((,class (:foreground ,lotus-yellow-0))))

    ;; SGML faces (used by some HTML modes)
    `(sgml-tag ((,class (:foreground ,lotus-blue-0 :weight bold))))
    `(sgml-attribute ((,class (:foreground ,lotus-orange-0))))
    `(sgml-value ((,class (:foreground ,lotus-green-1))))

    ;; Add these CSS/SCSS faces to the kanagawa-lotus-theme.el file:

    ;; CSS faces
    `(css-selector ((,class (:foreground ,lotus-blue-0 :weight bold))))
    `(css-property ((,class (:foreground ,lotus-blue-0))))
    `(css-proprietary-property ((,class (:foreground ,lotus-blue-0))))
    `(css-value ((,class (:foreground ,lotus-orange-0))))
    `(css-string ((,class (:foreground ,lotus-green-1))))
    `(css-function ((,class (:foreground ,lotus-teal-0))))

    ;; SCSS-mode faces
    `(scss-variable-face ((,class (:foreground ,lotus-red-0))))
    `(scss-keyword-face ((,class (:foreground ,lotus-violet-0))))
    `(scss-comment-face ((,class (:foreground ,lotus-gray-0 :style italic))))

    ;; Additional CSS faces
    `(font-lock-css-selector-face ((,class (:foreground ,lotus-blue-0 :weight bold))))
    `(font-lock-css-property-name-face ((,class (:foreground ,lotus-blue-0))))
    `(font-lock-css-property-value-face ((,class (:foreground ,lotus-orange-0))))

    ;; Web-mode CSS faces (if using web-mode)
    `(web-mode-css-selector-face ((,class (:foreground ,lotus-blue-0 :weight bold))))
    `(web-mode-css-property-name-face ((,class (:foreground ,lotus-blue-0))))
    `(web-mode-css-property-value-face ((,class (:foreground ,lotus-orange-0))))
    `(web-mode-css-function-face ((,class (:foreground ,lotus-teal-0))))
    `(web-mode-css-color-face ((,class (:foreground ,lotus-orange-0))))
    `(web-mode-css-priority-face ((,class (:foreground ,lotus-red-0))))

    ;; TypeScript/JavaScript faces
    `(typescript-jsdoc-tag ((,class (:foreground ,lotus-gray-0))))
    `(typescript-jsdoc-type ((,class (:foreground ,lotus-yellow-0))))
    `(typescript-jsdoc-value ((,class (:foreground ,lotus-green-1))))
    `(js2-function-param ((,class (:foreground ,lotus-red-0))))
    `(js2-external-variable ((,class (:foreground ,lotus-red-0))))
    `(js2-instance-member ((,class (:foreground ,lotus-red-0))))
    `(js2-jsdoc-html-tag-delimiter ((,class (:foreground ,lotus-blue-0))))
    `(js2-jsdoc-html-tag-name ((,class (:foreground ,lotus-blue-0))))
    `(js2-jsdoc-value ((,class (:foreground ,lotus-green-1))))
    `(js2-private-function-call ((,class (:foreground ,lotus-blue-0))))
    `(js2-private-member ((,class (:foreground ,lotus-red-0))))
    `(js2-keyword ((,class (:foreground ,lotus-red-0))))
    `(js2-this ((,class (:foreground ,lotus-red-0))))
    `(typescript-this ((,class (:foreground ,lotus-red-0))))
    `(typescript-keyword ((,class (:foreground ,lotus-red-0))))
    `(js2-constructor-call ((,class (:foreground ,lotus-yellow-0))))
    `(typescript-constructor-call ((,class (:foreground ,lotus-yellow-0))))

    ;; General programming faces that work across languages
    `(font-lock-function-name-face ((,class (:foreground ,lotus-blue-0 :weight bold))))
    `(font-lock-variable-name-face ((,class (:foreground ,lotus-red-0))))
    `(font-lock-keyword-face ((,class (:foreground ,lotus-violet-0 :weight bold))))
    `(font-lock-type-face ((,class (:foreground ,lotus-yellow-0))))
    `(font-lock-constant-face ((,class (:foreground ,lotus-orange-0))))
    `(font-lock-builtin-face ((,class (:foreground ,lotus-blue-0))))
    ...
    ;; Python specific
    `(python-decorators-face ((,class (:foreground ,lotus-violet-0))))
    `(py-decorators-face ((,class (:foreground ,lotus-violet-0))))

    ;; Java specific
    `(java-font-lock-modifier-face ((,class (:foreground ,lotus-violet-0))))
    `(java-font-lock-doc-tag-face ((,class (:foreground ,lotus-gray-0))))

    ;; C/C++ specific
    `(c-annotation-face ((,class (:foreground ,lotus-violet-0))))

    ;; Rust specific
    `(rust-builtin-formatting-macro ((,class (:foreground ,lotus-blue-0))))
    `(rust-string-interpolation ((,class (:foreground ,lotus-red-0))))

    ;; Go specific
    `(go-dot-mod-module-name ((,class (:foreground ,lotus-yellow-0))))
    `(go-package-name ((,class (:foreground ,lotus-violet-0))))

    ;; Ruby specific
    `(ruby-constant-face ((,class (:foreground ,lotus-yellow-0))))
    `(ruby-op-face ((,class (:foreground ,lotus-aqua-0))))

    ;; Tree-sitter based syntax highlighting (modern approach)
    `(tree-sitter-hl-face:type ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:property ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:property.access ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:property.definition ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:property.assignment ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:property.definition.assignment ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:member.assignment ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:field.assignment ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:member.object ((,class (:foreground ,lotus-orange-0))))
    `(tree-sitter-hl-face:member.builtin ((,class (:foreground ,lotus-orange-0))))
    `(tree-sitter-hl-face:member.assignment ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:field.builtin ((,class (:foreground ,lotus-orange-0))))
    `(tree-sitter-hl-face:object.key ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:key ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:member ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:field ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:keyword.modifier ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:keyword.operator ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:keyword.control ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:constructor.call ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:variable.builtin.this ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:keyword.modifier ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:storage.type ((,class (:foreground ,lotus-red-0))))
    ...
    `(tree-sitter-hl-face:variable ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:variable.builtin ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:variable.builtin.this ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:variable.language ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:variable.language.this ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:variable.parameter ((,class (:foreground ,lotus-yellow-0))))
    `(tree-sitter-hl-face:method ((,class (:foreground ,lotus-blue-0))))
    `(tree-sitter-hl-face:function ((,class (:foreground ,lotus-blue-0))))
    `(tree-sitter-hl-face:function.call ((,class (:foreground ,lotus-blue-0 :weight bold))))
    `(tree-sitter-hl-face:method.call ((,class (:foreground ,lotus-blue-0 :weight bold))))
    `(tree-sitter-hl-face:keyword ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:keyword.import ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:keyword.export ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:keyword.return ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:conditional ((,class (:foreground ,lotus-red-0))))
    `(tree-sitter-hl-face:operator ((,class (:foreground ,lotus-aqua-0))))
    `(tree-sitter-hl-face:punctuation ((,class (:foreground ,lotus-fg-0))))
    `(tree-sitter-hl-face:punctuation.bracket ((,class (:foreground ,lotus-fg-0))))
    `(tree-sitter-hl-face:punctuation.delimiter ((,class (:foreground ,lotus-fg-0))))))
